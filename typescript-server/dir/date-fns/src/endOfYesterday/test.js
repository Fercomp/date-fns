...
(0, vitest_1.describe)("endOfYesterday", () => {
    (0, vitest_1.it)("returns yesterday with the time settled to 23:59:59.999", () => {
        const clock = sinon_1.default.useFakeTimers(new Date(2014, 8 /* Sep */, 25, 14, 30, 45, 500).getTime());
        const result = (0, index_js_1.endOfYesterday)();
        (0, vitest_1.expect)(result).toEqual(new Date(2014, 8 /* Sep */, 24, 23, 59, 59, 999));
        clock.restore();
    });
