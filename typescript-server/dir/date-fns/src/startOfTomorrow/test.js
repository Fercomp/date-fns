...
(0, vitest_1.describe)("startOfTomorrow", () => {
    (0, vitest_1.it)("returns the start of tomorrow", () => {
        const clock = sinon_1.default.useFakeTimers(new Date(2014, 8 /* Sep */, 25, 14, 30, 45, 500).getTime());
        const result = (0, index_js_1.startOfTomorrow)();
        (0, vitest_1.expect)(result).toEqual(new Date(2014, 8 /* Sep */, 26));
        clock.restore();
    });
