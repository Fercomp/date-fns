...
(0, vitest_1.describe)("max", () => {
    (0, vitest_1.it)("returns the latest date", () => {
        const result = (0, index_js_1.max)([
            new Date(1989, 6 /* Jul */, 10),
            new Date(1987, 1 /* Feb */, 11),
        ]);
        (0, vitest_1.expect)(result).toEqual(new Date(1989, 6 /* Jul */, 10));
    });
    (0, vitest_1.it)("accepts array with more than 2 entries", () => {
        ...
        (0, vitest_1.expect)(result).toEqual(new Date(1995, 6 /* Jul */, 2));
    });
