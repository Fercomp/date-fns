...
(0, vitest_1.describe)("eachQuarterOfInterval", () => {
    (0, vitest_1.it)("returns an array with starts of quarters from the quarter of the start date to the quarter of the end date", () => {
        const result = (0, index_js_1.eachQuarterOfInterval)({
    ...
    (0, vitest_1.it)("returns one quarter if the both arguments are on the same quarter", () => {
        const result = (0, index_js_1.eachQuarterOfInterval)({
    ...
    (0, vitest_1.it)("returns one quarter if the both arguments are the same", () => {
        const result = (0, index_js_1.eachQuarterOfInterval)({
    ...
    (0, vitest_1.describe)("options.step", () => {
        ...
        (0, vitest_1.it)("returns an array with starts of days from the day of the start date to the day of the end date with the given step", () => {
            const result = (0, index_js_1.eachQuarterOfInterval)(interval, { step: 2 });
            (0, vitest_1.expect)(result).toEqual([
                new Date(2014, 0 /* Jan */, 1),
                new Date(2014, 6 /* Jul */, 1),
            ]);
        ...
        (0, vitest_1.it)("reverses array twice if `options.step` is negative and the interval is negative too", () => {
            const result = (0, index_js_1.eachQuarterOfInterval)({ start: interval.end, end: interval.start }, { step: -2 });
            (0, vitest_1.expect)(result).toEqual([
                new Date(2014, 0 /* Jan */, 1),
                new Date(2014, 6 /* Jul */, 1),
            ]);
        ...
        (0, vitest_1.it)("returns empty array if `options.step` is less than 1", () => {
            const result = (0, index_js_1.eachQuarterOfInterval)(interval, { step: 0 });
            (0, vitest_1.expect)(result).toEqual([]);
        });
        (0, vitest_1.it)("returns empty array if `options.step` is NaN", () => {
            const result = (0, index_js_1.eachQuarterOfInterval)(interval, { step: NaN });
            (0, vitest_1.expect)(result).toEqual([]);
        });
    });
});
