...
function add(date, duration) {
    ...
    const dateWithMonths = months || years ? (0, index_js_2.addMonths)(_date, months + years * 12) : _date;
    // Add weeks and days
    const dateWithDays = days || weeks ? (0, index_js_1.addDays)(dateWithMonths, days + weeks * 7) : dateWithMonths;
    // Add days, hours, minutes and seconds
    const minutesToAdd = minutes + hours * 60;
    const secondsToAdd = seconds + minutesToAdd * 60;
    const msToAdd = secondsToAdd * 1000;
    const finalDate = (0, index_js_3.constructFrom)(date, dateWithDays.getTime() + msToAdd);
    return finalDate;
}
exports.add = add;
